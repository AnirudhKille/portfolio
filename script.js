...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const projects = [
    {
      title: "EZ Shop",
      link: "https://github.com/AnirudhKille/ez-shop.git",
      ...
      description:
        " EZ Shop, a MERN stack ecommerce app, featuring user authentication, dynamic product categories, and a streamlined checkout process. Utilized React, TailwindCSS, MUI, Node, Express, and MongoDB, integrating Fakestore API for product data. The application allows users to seamlessly browse, add to the cart, and place orders.",
    },
    {
      title: "YouTube-Clone",
